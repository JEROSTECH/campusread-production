...
// Mobile/tablet pinch-to-zoom support
  ...
  return (
    ...
    >
      ...
      {/* Top Controls Bar */}
      <div className={`flex items-center justify-between px-2 lg:px-6 py-2.5 border-b shrink-0 ${themeMode === 'dark' ? 'bg-[#18191a] border-slate-800 text-white' : 'bg-white border-slate-200 text-slate-900'} shadow-sm`}>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-bold text-[11xs] lg:text-xs max-w-xs lg:max-w-md truncate">{book.title}</h3>
        ...
        <div className="hidden md:flex items-center gap-3">
          <button
            ...
            className="flex items-center gap-1.5 px-2 py-1 rounded-lg text-[11px] font-bold bg-slate-100 hover:bg-slate-200 text-slate-700 transition-colors"
          >
      ...
      <div className="flex-1 relative overflow-hidden flex">
        ...
        {isTocOpen && (
          <div className={`w-52 border-r p-2.5 overflow-y-auto shrink-0 ${themeMode === 'dark' ? 'bg-[#141516] border-slate-800 text-slate-300' : 'bg-white border-slate-200 text-slate-700'}`}>
        ...
        <div className="flex-1 overflow-auto p-2 lg:p-6 flex items-start justify-center">
          {loading ? (
            ...
            <div className={`relative w-[400px] max-w-none shadow-2xl rounded-lg overflow-hidden border border-slate-300 dark:border-slate-800 ${themeMode === 'sepia' ? 'sepia-[0.3]' : themeMode === 'dark' ? 'invert-[0.9] hue-rotate-180' : ''}`}>
      ...
      <div className={`px-3 py-2 border-t flex items-center justify-between text-xs shrink-0 ${themeMode === 'dark' ? 'bg-[#18191a] border-slate-800 text-white' : 'bg-white border-slate-200 text-slate-900'}`}>
        <div className="flex items-center gap-3">
